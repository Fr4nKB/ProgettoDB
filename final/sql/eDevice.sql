...
CREATE TABLE Presente (
    ...
    HubId INT NOT NULL,
    `Data` DATE NOT NULL,
    PRIMARY KEY (CodiceSpedizione, HubId),
    FOREIGN KEY (CodiceSpedizione) REFERENCES Spedizione(CodiceSpedizione),
...
CREATE TABLE Caso (
	CasoId INT AUTO_INCREMENT NOT NULL,
    CodiceGuasto VARCHAR(50),
    ModelloId INT NOT NULL,
	PRIMARY KEY (CasoId),
	FOREIGN KEY (CodiceGuasto) REFERENCES Guasto(CodiceGuasto),
...
CREATE TABLE Sintomo (
	SintomoId INT AUTO_INCREMENT NOT NULL,
    Nome VARCHAR(50) NOT NULL,
	Descrizione VARCHAR(255),
...
CREATE TABLE Cura (
	CasoId INT NOT NULL,
    CodiceRimedio VARCHAR(50) NOT NULL,
	PRIMARY KEY (CasoId, CodiceRimedio),
...
CREATE TABLE Causa (
	...
	PRIMARY KEY (CasoId, SintomoId),
	FOREIGN KEY (CasoId) REFERENCES Caso(CasoId),
    FOREIGN KEY (SintomoId) REFERENCES Sintomo(SintomoId)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
